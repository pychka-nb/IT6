...
// IT6.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CIT6App, CWinApp)
...
// Единственный объект CIT6App

CIT6App theApp;


// Инициализация CIT6App

BOOL CIT6App::InitInstance()
{
